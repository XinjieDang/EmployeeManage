...
<div class="maincontent">
    <div class="maincontentinner">
        ...
        <h4 class="widgettitle" style="background:#444;">查看个人信息</h4>
        <table id="dyntable" class="table table-bordered table-infinite">
            ...
            <tbody>
                <tr class="gradeX">
                    ...
                    <td>${stas.sta_id}</td>
                    <td>${stas.loginname}</td>
                    <td>${stas.staname}</td>
                    <td>
                        <c:choose>
                            <c:when test="${stas.sex == 1 }">男</c:when>
                            <c:otherwise>女</c:otherwise>
                        </c:choose>
                    </td>
                    <td>${stas.age}</td>
                    <td>${stas.dept.depname}</td>
                    <td>${stas.job.jobname}</td>
                    <td>${stas.IDcard}</td>
                    <td>${stas.education}</td>
                    <td>${stas.adress}</td>
                    <td>${stas.tel}</td>
                    <td>${stas.cre_date}</td>
                    <td>普通职工</td>
